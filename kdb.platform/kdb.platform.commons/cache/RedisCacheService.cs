...
namespace kdb.platform.commons.cache
{
    public class RedisCacheService : ICacheService
    {
        ...
        public bool Add(string key, string value)
        {
            if (!string.IsNullOrWhiteSpace(key))
                return _cache.StringSet(GetKeyForRedis(key), JsonConvert.SerializeObject(value));
        ...
        {
            if (!string.IsNullOrWhiteSpace(key))
                return _cache.StringSet(GetKeyForRedis(key), JsonConvert.SerializeObject(value), expiresAbsoulte);
            throw new NotImplementedException();
        }
        ...
        {
            if (!string.IsNullOrWhiteSpace(key))
                return JsonConvert.DeserializeObject<T>(_cache.StringGet(GetKeyForRedis(key)));
            throw new NotImplementedException();
        }
        ...
        {
            if (!string.IsNullOrWhiteSpace(key))
                return JsonConvert.DeserializeObject<object>(_cache.StringGet(GetKeyForRedis(key)));
            throw new NotImplementedException();
        }
